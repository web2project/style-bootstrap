    ...
    <body>
        <div class="container">
            <form class="form-signin" method="post" action="<?php echo $loginFromPage; ?>" name="loginform" accept-charset="utf-8">
                ...
                <input type="text" class="input-block-level" name="checkusername" placeholder="username">
                <input type="password" class="input-block-level" name="checkemail" placeholder="password">
                <button class="btn btn-large btn-primary right" type="submit" name="sendpass"><?php echo $AppUI->_('send password'); ?></button>
                <br />&nbsp;<br />&nbsp;
            </form>
        </div> <!-- /container -->
